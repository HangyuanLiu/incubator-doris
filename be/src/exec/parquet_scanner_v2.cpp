...
#include "exec/parquet_scanner_v2.h"
...
namespace doris {
ParquetScannerV2::ParquetScannerV2(RuntimeState* state,
...
ParquetScannerV2::~ParquetScannerV2() {
    close();
}

Status ParquetScannerV2::open() {
    return BaseScanner::open();
}

Status ParquetScannerV2::get_next(Tuple* tuple, MemPool* tuple_pool, bool* eof) {
...
Status ParquetScannerV2::open_next_reader() {
    // open_file_reader
