...
import org.apache.doris.sql.util.MoreMath;
...
import static org.apache.doris.sql.planner.cost.VariableStatsEstimate.buildFrom;
        ...
        extends SimpleStatsRule<JoinNode>
{
            ...
            PlanNodeStatsEstimate joinComplementStats)
    {
        ...
        for (VariableReferenceExpression variable : joinComplementStats.getVariablesWithKnownStatistics()) {
            ...
            outputStats.addVariableStatistics(variable, buildFrom(innerJoinSymbolStats)
