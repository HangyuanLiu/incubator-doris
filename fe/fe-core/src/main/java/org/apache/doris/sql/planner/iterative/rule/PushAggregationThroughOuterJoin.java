        ...
        implements Rule<AggregationNode>
{
    ...
    public Result apply(AggregationNode aggregation, Captures captures, Context context)
    {
        ...
        Optional<LogicalPlanNode> resultNode = coalesceWithNullAggregation(rewrittenAggregation, rewrittenJoin, context.getVariableAllocator(), context.getIdAllocator(), context.getLookup());
    ...
    private static LogicalPlanNode getOuterTable(JoinNode join)
    {
        checkState(join.getType() == JoinNode.Type.LEFT || join.getType() == JoinNode.Type.RIGHT, "expected LEFT or RIGHT JOIN");
        LogicalPlanNode outerNode;
        if (join.getType().equals(JoinNode.Type.LEFT)) {
    ...
    // null row.
    private Optional<LogicalPlanNode> coalesceWithNullAggregation(AggregationNode aggregationNode, LogicalPlanNode outerJoin, VariableAllocator variableAllocator, PlanNodeIdAllocator idAllocator, Lookup lookup)
    {
