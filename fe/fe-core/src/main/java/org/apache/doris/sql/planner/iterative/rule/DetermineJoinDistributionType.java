        ...
        implements Rule<JoinNode>
{
    ...
    public static boolean isBelowMaxBroadcastSize(JoinNode joinNode, Context context)
    {
        ...
        LogicalPlanNode buildSide = joinNode.getRight();
    ...
    private LogicalPlanNode getCostBasedJoin(JoinNode joinNode, Context context)
    {
    ...
    private LogicalPlanNode getSyntacticOrderJoin(JoinNode joinNode, Context context, Session.JoinDistributionType joinDistributionType)
    {
    ...
    private PlanNodeWithCost getJoinNodeWithCost(Context context, JoinNode possibleJoinNode)
    {
        ...
        int estimatedSourceDistributedTaskCount = 3;
