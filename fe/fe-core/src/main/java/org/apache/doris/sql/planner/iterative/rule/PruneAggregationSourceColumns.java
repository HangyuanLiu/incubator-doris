...
import org.apache.doris.sql.planner.optimizations.AggregationNodeUtils;
        ...
        implements Rule<AggregationNode>
{
    ...
    @Override
    public Rule.Result apply(AggregationNode aggregationNode, Captures captures, Context context)
    {
