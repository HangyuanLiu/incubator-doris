...
public class Plans
{
    public static LogicalPlanNode resolveGroupReferences(LogicalPlanNode node, Lookup lookup)
    {
    ...
    private static class ResolvingVisitor
            extends PlanVisitor<LogicalPlanNode, Void>
    {
        ...
        @Override
        public LogicalPlanNode visitPlan(LogicalPlanNode node, Void context)
        {
        ...
        @Override
        public LogicalPlanNode visitGroupReference(GroupReference node, Void context)
        {
